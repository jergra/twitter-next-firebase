                ...
                <div className="w-full">
                  ...
                  <div className="mt-7 flex space-x-3 w-full">
                    ...
                    <div className="flex-grow mt-2">
                      <textarea
// scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-700
                        ...
                        className="bg-transparent outline-none text-[#d9d9d9] text-lg placeholder-gray-500 
                         tracking-wide w-full min-h-[80px] scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-700"
                      />
